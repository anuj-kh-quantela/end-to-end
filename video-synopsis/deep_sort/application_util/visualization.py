...
class NoVisualization(object):
    ...
    def draw_trackers(self, trackers, test_dict):
        pass
...
class Visualization(object):
    ...
    def __init__(self, seq_info, update_ms):
        ...
        self.viewer = ImageViewer(
            ...
            update_ms, image_shape, seq_info["sequence_name"])
    ...
    def draw_trackers(self, tracks, test_dict):
        self.viewer.thickness = 2
        val = " "
        for track in tracks:
            ...
            self.viewer.rectangle(
                ...
                *track.to_tlwh().astype(np.int), label=str(val))
