    ...
    * 'ESC' : quit
    ...
    def rectangle(self, x, y, w, h, label=None):
        ...
        if label is not None:
            ...
            cv2.putText(self.image, label, center, fontFace=cv2.FONT_HERSHEY_PLAIN, fontScale=2, color=(255, 255, 255), thickness=1)
    ...
    def run(self, update_fun=None):
        ...
        out = cv2.VideoWriter("timeTagged-" + self._caption + video_format, fourcc, fps, self._window_shape)
		
        # self.enable_videowriter("output.avi", "MJPG", 15)
