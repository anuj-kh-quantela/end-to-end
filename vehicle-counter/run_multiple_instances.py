...
from traffic_congestion import TrafficCongestion
import numpy as np


def wrapper(video_channel, city_name, location_name, minm_area, roi):
		
	vo = TrafficCongestion(video_channel, city_name, location_name)
	vo.congestion(video_channel, minm_area=minm_area,roi=roi,plot_intermediate=False)
