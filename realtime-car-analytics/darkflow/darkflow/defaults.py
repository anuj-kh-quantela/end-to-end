class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('labels', 'darkflow/labels.txt', 'path to labels file')
        self.define('backup', 'darkflow/ckpt/', 'path to backup folder')
        self.define('summary', None, 'path to TensorBoard summaries directory')
        ...
        self.define('track', False, 'weither to perform tracking or not')
        self.define('trackObj', "person", 'which object(or person) to track')
        ...
        # ---------------------------------------------------------------------------------------
        self.define('counting_cars', False, 'whether to run or not')
        self.define('direction_detection', False, 'whether to run or not')
        self.define('speed_estimation', False, 'whether to run or not')
        self.define('traffic_signal_violation_detection', False, 'whether to run or not')
        # ---------------------------------------------------------------------------------------
