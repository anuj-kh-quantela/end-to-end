...
def save_config_file(path_to_save, boundary_points):
    ...
    # these parameters are to be found out with respect to road
    # and set by user
...
def define_roi(video_path, pDistance, pFrameRate, pSpeedLimit, user_boundary_points):
    ...
    global distance, frame_rate, speed_limit
    ...
    save_config_file(video_name, user_boundary_points)
